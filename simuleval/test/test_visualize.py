...
def test_visualize(root_path=ROOT_PATH):
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        cli.sys.argv[1:] = [
            "--agent",
            os.path.join(
                root_path, "examples", "speech_to_text", "whisper_waitk.py"
            ),
            "--source-segment-size",
            "500",
            "--waitk-lagging",
            ...
            os.path.join(root_path, "examples",
                         "speech_to_text", "source.txt"),
            "--target",
            os.path.join(root_path, "examples", "speech_to_text",
        ...
        source_path = os.path.join(root_path, "examples", "speech_to_text", "source.txt")
        source_length = 0
